    ...
    if(!farmData.empty()){
        ...
        if(farmData.contains("fieldData")){
            ...
            foreach(QString field, fieldData){
                ...
                int needed = 15 - l.length();
                for(int i = 0; i < needed; i++){
                    l.push_back("NULL");
                }
                fields.push_back(CField(l.at(0), l.at(1).toFloat(), l.at(2), l.at(3), l.at(4), l.at(5), l.at(6), l.at(7), l.at(8), l.at(9), l.at(10), l.at(11), l.at(12), l.at(13), l.at(14)));
            }
        }
        //WorkUnits
